...
\stefan{this is too hand-wavy: handwavy is ok in the introduction but from now on you should be very concrete. E.g., here you should discuss definitions of randomness in the literature, maybe even define entropy etc.}
