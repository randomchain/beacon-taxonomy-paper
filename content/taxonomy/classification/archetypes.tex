...
The most naïve implementation of a randomness beacon is an autocratic beacon, which collects input from an internal source. Examples of this type include \citealias{nistbeacon} and \citealias{fischer2011publicrandomnessservice}. 
...
Scaling \gls{mpc} protocols, can also be difficult, although \citealias{cascudo2017scrape} do improve on the performance of such protocols, especially in relation to a beacon, where the outcome is required to be published at regular intervals.
