...
%   Beacon types
As a way to structure the analysis of the above examples, we present some archetypes of randomness beacons rooted in the previously established beacon variations.
We describe the main strengths and weaknesses for each archetype.
...
This is because the internal input source itself cannot be verified by users.
