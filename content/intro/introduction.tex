...
% TODO: Introduce random beacons, Rabin

% TODO: Today, there exists some services, but only a few, that make random numbers.
...
% General scare --- most randomness is only random because we trust the makers to make the number "random".
