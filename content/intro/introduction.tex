...
lotteries \mtjnote[inline]{define different types of lotteries, e.g.\ \enquote{Lotto}, military lotteries, etc.} depends on random draws; voters for a particular cause in Switzerland are randomly selected; election voting recounts are randomly selected in the US\@; some consensus protocols depend on selecting a random participant; and many more.
...
\mtjnote[inline]{What is trusted randomness? E.g.\ what is decentralized verifiable}
