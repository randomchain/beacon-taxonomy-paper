...
%There are a number of interesting use cases that require or could benefit from randomness that is publicly available.

%Usecases - currently with no vietnam
...
%Nist is not trusted
The \gls{nist} beacon is perhaps the most recognized and public randomness beacon available.
...
% More adversaries. "Mistrust" is rising.
...
%Protect from adversaries, possible us
