...
\begin{description}
    ...
    \item[Integrity:]
        ...
        The integrity also relies on the beacon being unpredictable, i.e.\ no adversary \mtjnote[nofootnote, inline]{Only adversaries? All users I suppose?} should be able to predict the outcome before it is too late to manipulate it.
...
\begin{description}
    ...
    \item [Verifiability:]
        ...
        However, in some cases this may be impractical or the input should remain secret; thereby calling for another approach to proofing \mtjnote[nofootnote,inline]{proving?} validity of the outcome.
    ...
    \item [Input Reasoning:]
        ...
        Assuming we can trust the entropy level of the input, what assumptions are users able to make about the bias of the input \msmnote[nofootnote, inline]{I'M A DRUNK BOI. I MAKES NO SENSE}.
