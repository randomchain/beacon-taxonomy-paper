...
\begin{description}
    ...
    \item[Denial of Input] For beacons that use user input, the attacker can seek to prevent other users from contributing by overwhelming the beacon or contribution channels, and potentially biasing the input, violating the unpredictability and randomness properties of the beacon.
