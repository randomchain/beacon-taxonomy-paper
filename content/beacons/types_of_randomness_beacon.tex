...
It can also be seen that the output of the private external entropy source, $I_t$, can be manipulated or even manufactured by the autocratic beacon operator; without anybody being able to detect it.
...
\msmnote{not sure about iterative math}
