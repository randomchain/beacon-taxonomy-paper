...
Formally Shannon Entropy of a $b$-ary source $X$ with alphabet ${a_1, a_2, \ldots, a_n}$ and a probability distribution ${p_1, \ldots , p_n}$ where $p_i = p(a_i)$ is defined as~\cite{informationtheory}:
$$
H_{b} (X) = -\sum\limits_{i = 1}^n p_{i}\log_{b} p_{i}
$$
