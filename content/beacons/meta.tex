...
The quality of $R$ depend on the quality of $I$. It is, however, difficult to quantify these qualities without making assumptions on the function $f$ or assumptions about the applications using the output of the beacon \mtjnote{Maybe another part of the model should be how each solution quantifies this?}.
