...
There are two main distinctions when dealing with settings of a randomness beacon --- \emph{permissioned} and \emph{permissionless} \stefan{maybe this discussion / variants should be brought up already earlier in the requirements / properties of random beacons?}.
